          ...
          child: BlocBuilder<SubmissionsBloc, SubmissionsState>(
            builder: (context, state) {
              ...
              if (state.items.isEmpty) {
                return Center(
                  child: Text(
                    'No submissions yet. Create your first pitch draft.',
              ...
              return Column(
                ...
                children: [
                  Text(
                    'Track draft progress and submit when ready',
                                      ...
                                      child: OutlinedButton(
                                        onPressed: s.id.isEmpty
                                            ...
                                            : () => context
                                                .read<SubmissionsBloc>()
                                                .add(
                                                  SubmissionCompletenessRequested(
                                                      s.id),
                                                ),
