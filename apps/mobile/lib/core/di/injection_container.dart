  ...
  try {
    ...
    sl.registerLazySingleton<InvestorProfileRepository>(
      () => InvestorProfileRepositoryImpl(
          remote: sl<InvestorProfileRemoteDataSource>()),
    );
    ...
    sl.registerLazySingleton<SavedPitchesRepository>(
      () => SavedPitchesRepositoryImpl(
          remote: sl<SavedPitchesRemoteDataSource>()),
    );
    ...
    sl.registerLazySingleton(
        () => RefreshUserProfileUseCase(sl<AuthRepository>()));
    sl.registerLazySingleton(
        () => SendPasswordResetEmailUseCase(sl<AuthRepository>()));

    sl.registerLazySingleton(
        () => GetMyProfileUseCase(sl<UserProfileRepository>()));
    ...
    sl.registerLazySingleton(
        () => UpdateDraftUseCase(sl<SubmissionsRepository>()));
    sl.registerLazySingleton(
        () => DeleteDraftUseCase(sl<SubmissionsRepository>()));
    sl.registerLazySingleton(
        () => SubmitPitchUseCase(sl<SubmissionsRepository>()));
    sl.registerLazySingleton(
        () => CompletenessUseCase(sl<SubmissionsRepository>()));

    sl.registerLazySingleton(
        () => RunMatchingUseCase(sl<MatchingRepository>()));
    sl.registerLazySingleton(
        () => GetMatchResultsUseCase(sl<MatchingRepository>()));

    sl.registerLazySingleton(
        () => ListMyDocumentsUseCase(sl<DocumentsRepository>()));
    sl.registerLazySingleton(
        () => UploadDocumentUseCase(sl<DocumentsRepository>()));
    sl.registerLazySingleton(
        () => DeleteDocumentUseCase(sl<DocumentsRepository>()));
    sl.registerLazySingleton(
      () => DocumentValidationStatusUseCase(sl<DocumentsRepository>()),
    );

    sl.registerLazySingleton(
        () => SendInvitationUseCase(sl<InvitationsRepository>()));
    ...
    sl.registerLazySingleton(
        () => ListConversationsUseCase(sl<MessagingRepository>()));
    sl.registerLazySingleton(
        () => ListMessagesUseCase(sl<MessagingRepository>()));
    sl.registerLazySingleton(
    ...
    sl.registerLazySingleton(
        () => ListNotificationsUseCase(sl<MessagingRepository>()));
    sl.registerLazySingleton(
        () => MarkNotificationReadUseCase(sl<MessagingRepository>()));

    sl.registerLazySingleton(
        () => ListMeetingsUseCase(sl<MeetingsRepository>()));
    sl.registerLazySingleton(
    ...
    sl.registerLazySingleton(
        () => CreateMilestoneUseCase(sl<MilestonesRepository>()));
    sl.registerLazySingleton(
        () => UpdateMilestoneUseCase(sl<MilestonesRepository>()));
    sl.registerLazySingleton(
        () => SubmitMilestoneEvidenceUseCase(sl<MilestonesRepository>()));
    sl.registerLazySingleton(
        () => VerifyMilestoneUseCase(sl<MilestonesRepository>()));

    sl.registerLazySingleton(
        () => SubmitFeedbackUseCase(sl<FeedbackRepository>()));
    sl.registerLazySingleton(
        () => ListReceivedFeedbackUseCase(sl<FeedbackRepository>()));
    sl.registerLazySingleton(
        () => ListGivenFeedbackUseCase(sl<FeedbackRepository>()));
    sl.registerLazySingleton(
        () => FeedbackSummaryUseCase(sl<FeedbackRepository>()));

    sl.registerLazySingleton(
        () => GetInvestorProfileUseCase(sl<InvestorProfileRepository>()));
    sl.registerLazySingleton(
        () => CreateInvestorProfileUseCase(sl<InvestorProfileRepository>()));
    sl.registerLazySingleton(
        () => UpdateInvestorProfileUseCase(sl<InvestorProfileRepository>()));

    sl.registerLazySingleton(() => BrowseFeedUseCase(sl<FeedRepository>()));
    sl.registerLazySingleton(() => GetPitchUseCase(sl<FeedRepository>()));

    sl.registerLazySingleton(
        () => ListSavedPitchesUseCase(sl<SavedPitchesRepository>()));
    sl.registerLazySingleton(
        () => ToggleSavedPitchUseCase(sl<SavedPitchesRepository>()));
    ...
    // Log and rethrow so calling code sees the failure.
    AppLogger.error('initDependencies failed', error: e, stackTrace: st);
    rethrow;
  }
}
